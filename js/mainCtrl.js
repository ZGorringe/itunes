...
app.controller('mainCtrl', function($scope, itunesService){
  ...
  $scope.getSongData = function() {
    ...
    .then(function(data) {
      $scope.songData = songSorter(data);
    });
  }

  //Check that the above method is working by entering a name into the input field on your web app, and then console.log the resul    //Code here
